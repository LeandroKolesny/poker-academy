#!/usr/bin/env python3
"""
Script para copiar arquivo e reiniciar backend
"""
...
def copy_and_restart():
    ...
    try:
        ...
        output, _ = execute_command(client, "ls -la /root/Dojo_Deploy/poker-academy/poker_academy_api/src/routes/")
        ...
        remote_file = '/root/Dojo_Deploy/poker-academy/poker_academy_api/src/routes/class_routes.py'
        ...
        output, _ = execute_command(client, "ls -lh /root/Dojo_Deploy/poker-academy/poker_academy_api/src/routes/class_routes.py")
