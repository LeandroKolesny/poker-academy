#!/usr/bin/env python3
"""
Script para reconstrução SEGURA v2 - sem backup de uploads
"""
...
def rebuild():
    ...
    try:
        ...
        print(f"  - Uploads: Mantidos no volume Docker (5.8GB)")
        print("\n🎉 PRÓXIMOS PASSOS:")
...
if __name__ == "__main__":
    print("=" * 70)
    print("Reconstrução SEGURA v2 - Poker Academy")
    print("=" * 70)
    print(f"\nServidor: {SSH_HOST}")
    print("\nEste script irá:")
    print("  1. ✅ Fazer backup do banco de dados")
    print("  2. ✅ Parar containers (mantendo volumes)")
    print("  3. ✅ Remover apenas imagens")
    print("  4. ✅ Reconstruir imagens")
    print("  5. ✅ Iniciar containers")
    print("  6. ✅ Verificar integridade dos dados")
    print("\n⚠️  IMPORTANTE: Nenhum dado será perdido!")
    print("  - Banco de dados: Backup automático")
    print("  - Uploads: Mantidos em volumes Docker")
    print("\n" + "=" * 70)
