...
const AdminStudentGraphs = () => {
    ...
    // DEBUG LOGS
    useEffect(() => {
        console.log('🔍 DEBUG AdminStudentGraphs:');
        console.log('   selectedPartition:', selectedPartition);
        console.log('   partitions:', partitions);
        console.log('   filteredPartitions:', filteredPartitions);
        console.log('   partitions.length:', partitions.length);
        console.log('   filteredPartitions.length:', filteredPartitions.length);
    }, [selectedPartition, partitions, filteredPartitions]);
