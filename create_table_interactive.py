#!/usr/bin/env python3
"""
Script para criar a tabela user_progress de forma interativa
"""
...
def create():
    ...
    try:
        ...
        # Criar arquivo SQL no servidor usando cat
        print("1️⃣ Criando arquivo SQL no servidor...")
        
        # Usar cat com heredoc para criar o arquivo
        cat_cmd = """cat > /root/create_table.sql << 'EOF'
SET NAMES utf8mb4;
...
EOF"""
        ...
        execute_command(client, cat_cmd)
        
        # Passo 2: Executar arquivo SQL
        print("\n2️⃣ Executando arquivo SQL...")
        cmd = "docker exec poker_mysql bash -c 'mysql -u poker_user -pDojo@Sql159357 poker_academy < /root/create_table.sql'"
