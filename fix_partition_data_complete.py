#!/usr/bin/env python3
"""
Script para corrigir completamente os dados das partições
"""
...
def fix_data():
    ...
    try:
        ...
        print("1️⃣ Deletando dados antigos...")
        cmd1 = """docker exec poker_mysql mysql -u poker_user -pDojo@Sql159357 poker_academy -e "DELETE FROM particoes;" """
        execute_command(client, cmd1)
        
        # Inserir dados novos com encoding correto
        print("\n2️⃣ Inserindo dados novos...")
